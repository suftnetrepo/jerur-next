...
import Team from 'src/icons/lineal/Team';
import Check from 'src/icons/lineal/Check';
import Medal from 'src/icons/lineal/Medal';
import Earth from 'src/icons/lineal/Earth';
import Shield from 'src/icons/lineal/Shield';
import Target from 'src/icons/lineal/Target';
import Search from 'src/icons/lineal/Search';
import ChatTwo from 'src/icons/lineal/ChatTwo';
...
import ShopTwo from 'src/icons/lineal/ShopTwo';
import Browser from 'src/icons/lineal/Browser';
import Director from 'icons/solid-duo/Director';
import Settings from 'src/icons/lineal/Settings';
import Telephone from 'src/icons/lineal/Telephone';
import SearchTwo from 'src/icons/lineal/SearchTwo';
import Analytics from 'src/icons/lineal/Analytics';
import Megaphone from 'src/icons/lineal/Megaphone';
import ClockThree from 'src/icons/lineal/ClockThree';
