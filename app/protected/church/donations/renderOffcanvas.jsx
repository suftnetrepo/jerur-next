...
const RenderUserOffcanvas = ({
  ...
  const handleSubmit = async () => {
    setErrorMessages({});
    const validationResult = validate(fields, donationValidator.rules);
    ...
    if (fields._id) {
      ...
      handleSave({ ...fields, amount: parseFloat(fields.amount), date_donated: new Date() }).then((result) => {
        result && resetFields();
      });
    }
  };
    ...
    <Offcanvas show={show} onHide={handleClose} placement="end" style={{ width: '30%', backgroundColor: 'white' }}>
      ...
      <Offcanvas.Body>
        <Form>
          <div className="row">
            <div className="col-md-6">
              <Form.Group controlId="formFirstName" className="mb-3">
                <Form.Label className="text-dark">Donation Type</Form.Label>
                <Form.Select
                  name="role"
          ...
          <div className="row">
            <div className="col-md-6">
              <Form.Group controlId="formOnline" className="mb-3">
                <Form.Check
                  type="checkbox"
                  label="online"
                  name="online"
