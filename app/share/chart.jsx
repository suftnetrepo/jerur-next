...
const UserAggregates = ({ data = [] }) => {
    const chartData = useMemo(() => {
        ...
        const backgroundColors = data.map(
            (item) =>
                ROLE_COLORS[item.role.toLowerCase()] || "#6c757d"
        );
...
const Sparkline = ({ color }) => {
    const dataPoints = [20, 14, 19, 10, 23, 20, 22, 9, 12];
...
const NumberofInvested = () => (
    <Sparkline color="rgb(14, 168, 186)" />
);

const Portfoliovalue = () => (
    <Sparkline color="rgb(245, 184, 73)" />
);

const Returnsrate = () => (
    <Sparkline color="rgb(38, 191, 148)" />
);

const TotalInvested = () => (
    <Sparkline color="rgb(132, 90, 223)" />
);

export { UserAggregates, NumberofInvested, Portfoliovalue, Returnsrate, TotalInvested };